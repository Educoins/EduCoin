// Copyright (c) 2014 The EduCoin developers
    ...
    nWeight(0)
{
    ...
    resize(1280, 720);
    setWindowTitle(tr("EduCoin"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/EduCoin"));
    setWindowIcon(QIcon(":icons/EduCoin"));
#else
...
#ifdef Q_OS_WIN
    QFile html("C:/EduCoin/index.html");
#else
    QFile html("/opt/EduCoin/index.html");
#endif
...
void GUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/EduCoin-16"), tr("&About EduCoin"), this);
    aboutAction->setToolTip(tr("Show information about EduCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for EduCoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(QIcon(":/assets/icons/lock"), tr("&Encrypt Wallet..."), this);
    ...
    unlockWalletAction = new QAction(QIcon(":/assets/icons/lock_off"), tr("&Unlock Wallet..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    lockWalletAction = new QAction(QIcon(":/assets/icons/lock"), tr("&Lock Wallet"), this);
...
void GUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        if (mode != NT_FULL)
        {
            ...
            setWindowTitle(tr("EduCoin") + " - " + tr("Wallet") + ", " + sMode);
        };
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/EduCoin-16"));
            setWindowIcon(QIcon(":icons/EduCoin-16"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/EduCoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("EduCoin client") + QString(" ") + tr("[testnet]"));
                trayIcon->setIcon(QIcon(":/icons/EduCoin-16"));
    ...
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          ...
          "Do you want to pay the fee?").arg(
                BitcoinUnits::formatWithUnit(BitcoinUnits::EDU, nFeeRequired));
...
void GUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid EduCoin address or malformed URI parameters."));
    }
...
void GUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        encryptionIcon   .setAttribute("src", ":/assets/icons/lock_off");
        ...
        if (fWalletUnlockStakingOnly)
        {
			...
			encryptionIcon   .setAttribute("src", ":/assets/icons/lock_stake");
        } else
        {
    ...
    case WalletModel::Locked:
		...
		encryptionIcon   .setAttribute("src", ":/assets/icons/lock");
...
void GUI::updateStakingIcon()
{
    ...
    if (fIsStaking && nWeight)
    {
        ...
        unsigned nEstimateTime = 64 * nNetworkWeight / nWeight;
        QString text;
