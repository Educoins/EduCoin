! function(t) {
    ...
    function e(e) {
        return e === t && (e = t("[data-title]")), void 0 === e && (e = this), e.off("mouseenter").on("mouseenter", o)
    }
    ...
    function o(e) {
        ...
        if (!t("input, textarea").is(":focus") && "inline-block" != t(".iw-contextMenu").css("display")) {
            if (e.stopPropagation(), t("#tooltip").remove(), r = t(this), s = r.attr("data-title"), n = t('<div id="tooltip"></div>'), !s || "" == s) return !1;
            ...
            }), n.css("opacity", 0).html(s).appendTo("body"), "pointer" != r.css("cursor") && "A" != r.prop("tagName") && r.css("cursor", "help"), o(), t(window).resize(o), r.on("contextmenu mouseleave", i)
        }
    }
    t.fn.tooltip = e
}(jQuery), jQuery($.fn.tooltip);