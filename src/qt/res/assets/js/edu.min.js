...
function dumpStrings() {
    function e(e) {
        return 'QT_TRANSLATE_NOOP("ShadowBridge", "' + e + '"),\n'
    }
    var t = "";
...
$(function() {
    ...
    }), overviewPage.init(), receivePageInit(), transactionPageInit(), addressBookInit(), shadowChatInit(), chainDataPage.init(), walletManagementPage.init(), $(".footable > tbody tr").selection()
...
var base58 = {
    ...
    unit = {
        ...
        setType: function(e) {
            switch (this.type = void 0 == e ? 0 : e, e) {
                case 1:
                    this.name = "mEDU", this.display = "mEDU";
                    break;
                case 2:
                    this.name = "uEDU", this.display = "&micro;EDU";
                    break;
                case 3:
                    this.name = "sEDU", this.display = "Satoshi";
                    break;
                default:
    ...
    overviewPage = {
        init: function() {
            this.balance = $(".balance"), this.shadowBal = $(".shadow_balance"), this.reserved = $("#reserved"), this.stake = $("#stake"), this.unconfirmed = $("#unconfirmed"), this.immature = $("#immature"), this.total = $("#total")
        },
        updateBalance: function(e, t, a, s, n) {
            void 0 == e ? (e = this.balance.data("orig"), t = this.shadowBal.data("orig"), a = this.stake.data("orig"), s = this.unconfirmed.data("orig"), n = this.immature.data("orig")) : (this.balance.data("orig", e), this.shadowBal.data("orig", t), this.stake.data("orig", a), this.unconfirmed.data("orig", s), this.immature.data("orig", n)), this.formatValue("balance", e), this.formatValue("shadowBal", t), this.formatValue("stake", a), this.formatValue("unconfirmed", s), this.formatValue("immature", n), this.formatValue("total", e + a + s + n + t)
        },
    ...
    verified_list = {
        EU1ocjJNR4jB2Xa6LjXRUrRjY27KuLhuju: {
            username: "EduCoinTeam",
            title: "EduTeam",
            custom_avatar: !1
        }
    },
