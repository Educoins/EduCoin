...
extern json_spirit::Value sendedutotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentoedu(const json_spirit::Array& params, bool fHelp);
